...
export function OrderProvider({ children }: { children: ReactNode }) {
  ...
  const mapOrder = (o: any): Order => {
    ...
    if (dealerName === "Unknown Dealer" && dId) {
      ...
      if (foundDealer) {
        dealerName = foundDealer.name || foundDealer.companyName || "Unknown Dealer";
      }
    }
    ...
    return {
      ...
      id: o._id || o.id,
      dealer: dealerName,
      dealerId: o.dealerId?._id || o.dealerId,
      product: productName,
      productId: o.products && o.products.length > 0
        ? (o.products[0].productId?._id || o.products[0].productId)
        : (o.productId?._id || o.productId),
  ...
  const fetchOrders = async () => {
    ...
    try {
      ...
      const mappedOrders = res.data.map(mapOrder);
